...
public class CCuenta {
	...
	/**
	 * Define con un n�mero el tipo de inter�s que tiene la cuenta
	 */
	 ...
	 * @param tipo Indica el valor del inter�s de la cuenta
	 */
	...
	/**
	 * Ense�a el valor que hay en nombre
	...
	/**
	 * Ense�a el valor guardado en el momento del saldo
	...
	/**
	 * Este m�todo sirve para a�adir dinero al saldo de tu cuenta
	 * 
	 ...
	 * 
	 * @param tipoInter�s Indica el nuevo interes
	 */
